...
const ProfileMenu = (props: Props): JSX.Element => {
  ...
  let type = ''
  const addMoreSocial = authState?.discord && !oauthConnectedState.discord ||
  ...
  useEffect(() => {
    ...
    if (selfUser.identityProviders.value)
      for (let ip of selfUser.identityProviders.value) {
        switch (ip.type) {
          case 'discord':
            setOauthConnectedState(oauthConnectedState => { return {...oauthConnectedState, discord: true }})
            break
          case 'facebook':
            setOauthConnectedState(oauthConnectedState => { return {...oauthConnectedState, facebook: true }})
            break
          case 'linkedin':
            setOauthConnectedState(oauthConnectedState => { return {...oauthConnectedState, linkedin: true }})
            break
          case 'google':
            setOauthConnectedState(oauthConnectedState => { return {...oauthConnectedState, google: true }})
            break
          case 'twitter':
            setOauthConnectedState(oauthConnectedState => { return {...oauthConnectedState, twitter: true }})
            break
          case 'github':
            setOauthConnectedState(oauthConnectedState => { return {...oauthConnectedState, github: true }})
            break
        }
      }
